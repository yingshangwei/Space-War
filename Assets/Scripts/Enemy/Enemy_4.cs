...
public class Enemy_4: MonoBehaviour {
	...
	private const float ShotScore = 50;   //击中当前怪物得分
	private const float DeathScore = 2000; //击败当前怪物得分
	public static  float DownSpeed = 0.5f;   //下降速度
	public static  float RotateSpeed = 45f;//旋转速度
	...
	//移动
	void mMove() {
		transform.Translate (Vector3.down * DownSpeed * Time.deltaTime * ((Player.Score)/210000+1));
